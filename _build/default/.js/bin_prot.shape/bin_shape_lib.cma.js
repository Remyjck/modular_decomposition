(function(globalThis)
   {"use strict";
    ...
    function t_of_sexp$1(of_a,sexp)
     {if(0 === sexp[0])
       {var
         _bL_=sexp[1],
         _bM_=caml_string_compare(_bL_,cst_annotate),
         switch$0=0;
        if(0 <= _bM_)
         if(0 < _bM_)
          if(caml_string_notequal(_bL_,cst_application))
           if(caml_string_notequal(_bL_,cst_base))
            if(caml_string_notequal(_bL_,cst_poly_variant))
             if(caml_string_notequal(_bL_,cst_rec_app))
              if(caml_string_notequal(_bL_,cst_record))
               if(caml_string_notequal(_bL_,cst_tuple))
                if(caml_string_notequal(_bL_,cst_var))
                 {if(! caml_string_notequal(_bL_,cst_variant))switch$0 = 5}
                else
                 switch$0 = 9;
               else
                switch$0 = 3;
         ...
         if(caml_string_notequal(_bL_,cst_Annotate))
          if(caml_string_notequal(_bL_,cst_Application))
           if(caml_string_notequal(_bL_,cst_Base))
            if(caml_string_notequal(_bL_,cst_Poly_variant))
             if(caml_string_notequal(_bL_,cst_Rec_app))
        ...
        switch(switch$0)
         {case 1:return caml_call2(Sexplib0_Sexp_conv_error[5],tp_loc$0,sexp);
          ...
          case 7:return caml_call2(Sexplib0_Sexp_conv_error[5],tp_loc$0,sexp);
          case 8:return caml_call2(Sexplib0_Sexp_conv_error[5],tp_loc$0,sexp);
          case 9:return caml_call2(Sexplib0_Sexp_conv_error[5],tp_loc$0,sexp)
          }}
      else
       {var _bN_=sexp[1];
        if(! _bN_)
        ...
        var
         _bP_=_bO_[1],
         _bQ_=caml_string_compare(_bP_,cst_annotate$0),
         switch$1=0;
        if(0 <= _bQ_)
         if(0 < _bQ_)
          if(caml_string_notequal(_bP_,cst_application$0))
           if(caml_string_notequal(_bP_,cst_base$0))
            if(caml_string_notequal(_bP_,cst_poly_variant$0))
             if(caml_string_notequal(_bP_,cst_rec_app$0))
              if(caml_string_notequal(_bP_,cst_record$0))
               if(caml_string_notequal(_bP_,cst_tuple$0))
                if(caml_string_notequal(_bP_,cst_var$0))
                 {if(! caml_string_notequal(_bP_,cst_variant$0))switch$1 = 5}
                else
                 switch$1 = 9;
               else
                switch$1 = 3;
         ...
         if(caml_string_notequal(_bP_,cst_Annotate$0))
          if(caml_string_notequal(_bP_,cst_Application$0))
           if(caml_string_notequal(_bP_,cst_Base$0))
            if(caml_string_notequal(_bP_,cst_Poly_variant$0))
             if(caml_string_notequal(_bP_,cst_Rec_app$0))
        ...
        switch(switch$1)
         {case 1:
           var sexp_args$7=_bN_[2];
           if(sexp_args$7)
            {var _bW_=sexp_args$7[2];
             if(_bW_ && ! _bW_[2])
              {var
                v1$5=_bW_[1],
                v0$15=sexp_args$7[1],
               ...
               return [0,v0$16,v1$6]}}
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 2:
           var sexp_args$5=_bN_[2];
           if(sexp_args$5)
            {var _bU_=sexp_args$5[2];
             if(_bU_ && ! _bU_[2])
              {var
                v1$1=_bU_[1],
                v0$11=sexp_args$5[1],
           ...
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 3:
           var sexp_args$1=_bN_[2];
           if(sexp_args$1 && ! sexp_args$1[2])
            {var v0$3=sexp_args$1[1],v0$4=caml_call2(Base[139],of_a,v0$3);
             return [2,v0$4]}
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 4:
           var sexp_args$2=_bN_[2];
           if(sexp_args$2 && ! sexp_args$2[2])
            {var
              ...
              v0$6=caml_call2(Base[139],_bS_,v0$5);
             return [3,v0$6]}
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 5:
           var sexp_args=_bN_[2];
              ...
              _bR_=
               function(sexp)
                {if(1 === sexp[0])
                 ...
                 return caml_call3
                         (Sexplib0_Sexp_conv_error[2],tp_loc$0,2,sexp)},
              v0$0=caml_call2(Base[139],_bR_,v0);
             return [4,v0$0]}
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 6:
           var sexp_args$4=_bN_[2];
           if(sexp_args$4 && ! sexp_args$4[2])
            {var v0$9=sexp_args$4[1],of_a$0=caml_call1(Base[152],of_a);
             if(0 === v0$9[0])
              var v0$10=caml_call2(Sexplib0_Sexp_conv_error[16],tp_loc,v0$9);
             else
              {var
                field_sexps=v0$9[1],
                sorted_field=[0,0],
                   ...
                   if(1 === _bE_[0])
                    {var _bF_=_bE_[1];
                     if(_bF_)
                      {var _bG_=_bF_[1];
                       if(0 === _bG_[0])
                        {var _bH_=_bF_[2],_bI_=_bG_[1],switch$2=0;
                         if(! _bH_ || ! _bH_[2])switch$2 = 1;
                         if(switch$2)
                          {var tail=param[2];
                           if(caml_string_notequal(_bI_,cst_sorted))
                            {if(Sexplib0_Sexp_conv[26][1])extra[1] = [0,_bI_,extra[1]]}
                           else
                            if(sorted_field[1])
                             duplicates[1] = [0,_bI_,duplicates[1]];
                            else
                             {if(_bH_)
                               {if(_bH_[2])throw [0,Assert_failure,_c_];
                                var x=_bH_[1],field_sexp=x}
                              else
                               var
                                field_sexp=
                              ...
                              var
                               ...
                               fvalue=caml_call2(Base[139],_bJ_,field_sexp);
                              sorted_field[1] = [0,fvalue]}
                           var param=tail;
                           continue}}}}
                   caml_call2(Sexplib0_Sexp_conv_error[10],tp_loc,_bE_)}
                 if(duplicates[1])
                  var
                   v0$10=
                    caml_call3
                  ...
                  if(extra[1])
                   ...
                   {var _bK_=sorted_field[1];
                    if(_bK_)
                     var sorted_value=_bK_[1],v0$10=[0,sorted_value];
                    else
                     var
                      v0$10=
                       caml_call3
           ...
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 7:
           var sexp_args$6=_bN_[2];
           if(sexp_args$6)
            {var _bV_=sexp_args$6[2];
             if(_bV_ && ! _bV_[2])
              {var
                v1$3=_bV_[1],
                v0$13=sexp_args$6[1],
           ...
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 8:
           var sexp_args$3=_bN_[2];
           if(sexp_args$3)
            {var _bT_=sexp_args$3[2];
             if(_bT_ && ! _bT_[2])
              {var
                v1=_bT_[1],
                v0$7=sexp_args$3[1],
           ...
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp);
          case 9:
           var sexp_args$0=_bN_[2];
           if(sexp_args$0 && ! sexp_args$0[2])
            {var v0$1=sexp_args$0[1],v0$2=caml_call1(Base[119],v0$1);
             return [8,v0$2]}
           return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$0,_bP_,sexp)
          }}
       ...
       {case 0:
        ...
        case 3:
         var
          ...
          v0$7=caml_call2(Base[140],_bC_,v0$6);
          ...
          _bD_=
           function(param)
            {var
             ...
             return [1,[0,v0$0,[0,v1$0,0]]]},
          v0$9=caml_call2(Base[140],_bD_,v0$8);
          ...
          _bB_=
           function(param)
            {var
              ...
              v1$0=caml_call1(of_a$0,v1);
             return [1,[0,v0$0,[0,v1$0,0]]]},
          arg=caml_call2(Base[140],_bB_,v_sorted),
     ...
     {switch(x[0])
       {case 0:var x$0=x[2],u=x[1];return [0,u,caml_call1(f,x$0)];
        ...
        case 3:
         ...
         return [3,caml_call2(Base_List[74],l,_bw_)];
        case 4:
         var
          l$0=x[1],
          _bx_=
         ...
         return [4,caml_call2(Base_List[74],l$0,_bx_)];
        case 5:
         var t=x[1],_by_=Base_Option[30];
         return [5,map(t,function(_bA_){return caml_call2(_by_,_bA_,f)})];
        case 6:
         var l$1=x[2],x$1=x[1],_bz_=caml_call2(Base_List[74],l$1,f);
         return [6,caml_call1(f,x$1),_bz_];
        case 7:
         var l$2=x[2],t$0=x[1];return [7,t$0,caml_call2(Base_List[74],l$2,f)];
        default:var v=x[1];return [8,v]}}
    function to_string$1(t)
     {var _bv_=sexp_of_t$2(function(param){return _q_},t);
      return caml_call1(Base[84][16],_bv_)}
    function digest_layer(param)
     {switch(param[0])
       {case 0:
        ...
        case 1:
         var l=param[2],u$0=param[1],_bl_=[0,list(l),0];
         return constructor(cst_base$1,[0,uuid(u$0),_bl_]);
        case 2:
        ...
        case 3:
         ...
         return constructor
                 (cst_record$1,
                  [0,list(caml_call2(Base_List[74],l$1,_bn_)),_bm_]);
        case 4:
         var
          l$2=param[1],
          _bo_=0,
          _bp_=
           function(param)
            {var l=param[2],s=param[1],_bu_=list(l);
             return pair(caml_call1(string,s),_bu_)};
         return constructor
                 (cst_variant$1,
                  [0,list(caml_call2(Base_List[74],l$2,_bp_)),_bo_]);
        case 5:
         var
          table=param[1],
          _bq_=0,
          _br_=
           function(param)
            {var y=param[2],x$0=param[1];
             if(y)
              var x=y[1],_bt_=constructor(cst_some,[0,x,0]);
             else
              var _bt_=constructor(cst_none,0);
             return pair(caml_call1(string,x$0),_bt_)};
         return constructor
                 (cst_poly_variant$1,
                  [0,list(caml_call2(Base_List[74],table[1],_br_)),_bq_]);
        case 6:
         var l$3=param[2],x$0=param[1];
         return constructor(cst_application$1,[0,x$0,[0,list(l$3),0]]);
        case 7:
         var l$4=param[2],n=param[1],_bs_=[0,list(l$4),0];
         return constructor(cst_rec_app$1,[0,int$0(n),_bs_]);
        default:
    ...
    function equal(x,y)
     {var _bj_=to_digest$0(y),_bk_=caml_call2(compare$0,to_digest$0(x),_bj_);
      return caml_call2(Base[202],_bk_,0)}
    ...
    function get_poly_variant(x)
     {if(1 === x[0]){var match=x[1],desc=match[1];return [1,desc]}
      var l=x[1],_bg_=Base_Option[30];
      function _bh_(x){return [2,x]}
      return [0,map(l,function(_bi_){return caml_call2(_bg_,_bi_,_bh_)})]}
    var Def=[0];
    ...
    function poly_variant(loc,l)
     {return create$0
              ([5,
                create
                 (loc,
                  function(_be_,_bf_){return equal_option(equal,_be_,_bf_)},
                  l)])}
       ...
       {case 0:
         ...
         if(0 === b_067[0])
          {var
            ...
            b_013=b_067[1],
            a_014=a_066[2],
            n=caml_call2(compare,_aW_,b_013);
           return 0 === n?cmp_a(a_014,b_015):n}
         return -1;
        case 1:
         var _aX_=a_066[2],_aY_=a_066[1];
         switch(b_067[0])
          {case 0:break;
           case 1:
            var
             b_019=b_067[2],
             b_017=b_067[1],
             n$0=caml_call2(compare,_aY_,b_017);
            if(0 === n$0)
             {var _aZ_=function(a_020,b_021){return cmp_a(a_020,b_021)};
              return caml_call3(Base[136],_aZ_,_aX_,b_019)}
            return n$0;
           default:return -1}
         break;
        case 2:
         ...
         switch(b_067[0])
          {case 0:break;
           ...
           case 2:
            var
             b_023=b_067[1],
             _a1_=function(a_024,b_025){return cmp_a(a_024,b_025)};
            return caml_call3(Base[136],_a1_,_a0_,b_023);
           default:return -1}
         break;
        case 3:
         var _a2_=a_066[1];
         switch(b_067[0])
          {case 0:break;
           ...
           case 3:
            ...
            return caml_call3(Base[136],_a3_,_a2_,b_027);
           default:return -1}
         break;
        case 4:
         var _a4_=a_066[1];
             ...
             _a5_=
              function(a_036,b_037)
               {var
                ...
                if(0 === n)
                 {var _bd_=function(a_042,b_043){return cmp_a(a_042,b_043)};
                  return caml_call3(Base[136],_bd_,t_039,t_041)}
                return n};
            return caml_call3(Base[136],_a5_,_a4_,b_035);
           default:return -1}
         break;
        case 5:
         var _a6_=a_066[1];
         switch(b_067[0])
          {case 0:break;
           ...
           case 5:
            var b_045=b_067[1];
            if(caml_call2(Ppx_compare_lib[1],_a6_,b_045))return 0;
            var
             _aT_=b_045[1],
             _aU_=_a6_[1],
             _aV_=
              function(a_004,b_005)
               {var
                ...
                if(0 === n)
                 {var _bc_=function(a_048,b_049){return cmp_a(a_048,b_049)};
                  return caml_call3(Base[149],_bc_,t_007,t_009)}
                return n};
            return caml_call3(Base[136],_aV_,_aU_,_aT_);
           default:return -1}
         break;
        case 6:
         var _a7_=a_066[2],_a8_=a_066[1];
         switch(b_067[0])
          {case 0:break;
           case 1:switch$0 = 1;break;
           case 2:switch$0 = 2;break;
           ...
           case 6:
            var b_053=b_067[2],b_051=b_067[1],n$1=cmp_a(_a8_,b_051);
            if(0 === n$1)
             {var _a9_=function(a_054,b_055){return cmp_a(a_054,b_055)};
              return caml_call3(Base[136],_a9_,_a7_,b_053)}
            return n$1;
           default:return -1}
         break;
        case 7:
         var _a__=a_066[2],_a$_=a_066[1];
         switch(b_067[0])
          {case 0:break;
           case 1:switch$0 = 1;break;
           case 2:switch$0 = 2;break;
           ...
           case 7:
            var
             b_059=b_067[2],
             b_057=b_067[1],
             n$2=caml_call2(Base[115],_a$_,b_057);
            if(0 === n$2)
             {var _ba_=function(a_060,b_061){return cmp_a(a_060,b_061)};
              return caml_call3(Base[136],_ba_,_a__,b_059)}
            return n$2;
           default:return -1}
         break;
        default:
         ...
         switch(b_067[0])
          {case 0:break;
           ...
           case 6:switch$0 = 6;break;
           case 7:return 1;
           default:var b_063=b_067[1];return caml_call2(Base[115],_bb_,b_063)}}
      switch(switch$0)
       {case 0:return 1;
        case 1:return 1;
        case 2:return 1;
        ...
        case 5:return 1;
        default:return 1}}
    var t_of_sexp$2=function _aS_(_aR_){return _aS_.fun(_aR_)};
    runtime.caml_update_dummy
     (t_of_sexp$2,
      function(sexp)
       {if(0 === sexp[0])
         {var _aN_=sexp[1],switch$0=0;
          if
           (caml_string_notequal(_aN_,cst_Exp)
            &&
            caml_string_notequal(_aN_,cst_exp))
           switch$0 = 1;
          if(! switch$0)
         ...
         {var _aO_=sexp[1];
          ...
          var _aQ_=_aP_[1],switch$1=0;
          if
           (caml_string_notequal(_aQ_,cst_Exp$0)
            &&
            caml_string_notequal(_aQ_,cst_exp$0))
           switch$1 = 1;
          if(! switch$1)
           {var sexp_args=_aO_[2];
            if(sexp_args && ! sexp_args[2])
             {var v0=sexp_args[1],v0$0=t_of_sexp$1(t_of_sexp$2,v0);
              return [0,v0$0]}
            return caml_call3(Sexplib0_Sexp_conv_error[4],tp_loc$1,_aQ_,sexp)}}
    ...
    function _M_(param)
     {if(param[1] === Not_a_tuple)
       {var v0=param[2],v0$0=of_a(v0);return [1,[0,_N_,[0,v0$0,0]]]}
